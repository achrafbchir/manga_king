...
<div id="create_manga">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('admin.manga.store')}}" method="post" class="row">
                @csrf
                ...
                <div class="form-group col-md-6 col-sm-12">
                    ...
                    <input type="number" name="season" class="form-control" placeholder="Manga season..." min="1" value="1" required>
                </div>
