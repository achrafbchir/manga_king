                    ...
                    @foreach($mangas as $manga)
                        <tr class="row">
                            ...
                            <td class="col-3" style="font-size: 18px !important;">
                                ...
                                <a href="{{route('admin.manga.show', ['id' => $manga->id ]) }}" role="button" class="edit-infos mr-3" style="color: #080 !important;" data-toggle="modal" data-target="#mangaEdit"><i class="far fa-edit"></i></a>
